...
class GFSelectColumns
{
    public static function select_columns_page()
    {
        ...
        ?>
        <div
            class="panel-instructions"><?php esc_html_e('Drag & drop to order and select which columns are displayed in the entries table.', 'gravityforms') ?></div>
        ...
        <div class="panel-buttons">
            <input type="button" value="  <?php esc_attr_e('Save', 'gravityforms'); ?>  " class="button-primary"
                   onclick="SelectColumns();"/>&nbsp;
            <input type="button" value="<?php esc_attr_e('Cancel', 'gravityforms'); ?>" class="button"
