...
class GFEntryDetail
{
    ...
    public static function lead_detail_page()
    {
        ...
        <form method="post" id="entry_form" enctype='multipart/form-data'>
            ...
            <input type="hidden" name="screen_mode" id="screen_mode"
                   value="<?php echo esc_attr(rgpost('screen_mode')) ?>"/>

            <input type="hidden" name="entry_id" id="entry_id" value="<?php echo absint($lead['id']) ?>"/>

            <div class="wrap gf_entry_wrap">
                <h2 class="gf_admin_page_title">
                    <span><?php echo esc_html__('Entry #', 'gravityforms') . absint($lead['id']); ?></span><span
                ...
                <div id="poststuff" class="metabox-holder has-right-sidebar">
                    <div id="side-info-column" class="inner-sidebar">
                            ...
                            <div class="inside">
                                <div id="submitcomment" class="submitbox">
                                    <div id="minor-publishing" style="padding:10px;">
                                        <?php esc_html_e('Entry Id', 'gravityforms'); ?>
                                        : <?php echo absint($lead['id']) ?><br/><br/>
                                        <?php esc_html_e('Submitted on', 'gravityforms'); ?>
                                        : <?php echo esc_html(GFCommon::format_date($lead['date_created'], false, 'Y/m/d')) ?>
                                        <br/><br/>
                                        <?php esc_html_e('User IP', 'gravityforms'); ?>
                                        ...
                                        if (!empty($lead['created_by']) && $usermeta = get_userdata($lead['created_by'])) {
                                            ...
                                            <a href="user-edit.php?user_id=<?php echo absint($lead['created_by']) ?>"
                                               alt="<?php esc_attr_e('View user profile', 'gravityforms'); ?>"
                                               title="<?php esc_attr_e('View user profile', 'gravityforms'); ?>"><?php echo esc_html($usermeta->user_login) ?></a>
                                            <br/><br/>
                                            <?php
                                        }
                                        ?>
                                        ...
                                        <a href="<?php echo esc_url($lead['source_url']) ?>" target="_blank"
                                           alt="<?php echo esc_attr($lead['source_url']) ?>"
                                           title="<?php echo esc_attr($lead['source_url']) ?>">.../<?php echo esc_html(GFCommon::truncate_url($lead['source_url'])) ?></a>
                                        <br/><br/>
                                        <?php
                                        if (!empty($lead['post_id'])) {
                                            ...
                                            <a href="post.php?action=edit&post=<?php echo absint($post->ID) ?>"
                                               alt="<?php esc_attr_e('Click to edit post', 'gravityforms'); ?>"
                                               title="<?php esc_attr_e('Click to edit post', 'gravityforms'); ?>"><?php echo esc_html($post->post_title) ?></a>
                                            <br/><br/>
                                            <?php
                                        }
                                            ...
                                            switch ($lead['status']) {
                                                case 'spam' :
                                                    if (GFCommon::spam_enabled($form['id'])) {
                                                        ?>
                                                        <a onclick="jQuery('#action').val('unspam'); jQuery('#entry_form').submit()"
                                                           href="#"><?php esc_html_e('Not Spam', 'gravityforms') ?></a>
                                                        <?php
                                                    ...
                                                    if (GFCommon::current_user_can_any('gravityforms_delete_entries')) {
                                                        ...
                                                        <a class="submitdelete deletion"
                                                           onclick="if ( confirm('<?php echo esc_js(__("You are about to delete this entry. 'Cancel' to stop, 'OK' to delete.", 'gravityforms')); ?>') ) {jQuery('#action').val('delete'); jQuery('#entry_form').submit(); return true;} return false;"
                                                           href="#"><?php esc_html_e('Delete Permanently', 'gravityforms') ?></a>
                                                        <?php
                                                    }
                                                ...
                                                case 'trash' :
                                                    ?>
                                                    <a onclick="jQuery('#action').val('restore'); jQuery('#entry_form').submit()"
                                                       href="#"><?php esc_html_e('Restore', 'gravityforms') ?></a>
                                                    <?php
                                                    if (GFCommon::current_user_can_any('gravityforms_delete_entries')) {
                                                        ?>
                                                        |
                                                ...
                                                default :
                                                    if (GFCommon::current_user_can_any('gravityforms_delete_entries')) {
                                                        ...
                                                        <a class="submitdelete deletion"
                                                           ...
                                                           href="#"><?php esc_html_e('Move to Trash', 'gravityforms') ?></a>
                                                        <?php
                                                    ...
                                                    if (GFCommon::spam_enabled($form['id'])) {
                                                        ...
                                                        <a class="submitdelete deletion"
                                                           ...
                                                           href="#"><?php esc_html_e('Mark as Spam', 'gravityforms') ?></a>
                                                        <?php
                                                    }
                                            }
                                ...
                                <div class="inside">
                                    ...
                                    <div>
                                        ...
                                        if (!is_array($notifications) || count($form['notifications']) <= 0) {
                                            ...
                                            <a href="<?php echo admin_url("admin.php?page=gf_edit_forms&view=settings&subview=notification&id={$form_id}") ?>"
                                            ...
                                            <div id="notifications_override_settings" style="display:none;">
                                                ...
                                                <p class="description" style="padding-top:0; margin-top:0; width:99%;">
                                                    You may override the default notification settings
                                                    by entering a comma delimited list of emails to which the selected
                                                    notifications should be sent.</p>
                                                <label
                                                ...
                                                <input type="text" name="notification_override_email"
                                                       id="notification_override_email" style="width:99%;"/>
                                                <br/><br/>

                                            </div>

                                            <input type="button" name="notification_resend"
                        ...
                        <div class="detail-view-print">
                            <a href="javascript:;"
                               onclick="var notes_qs = jQuery('#gform_print_notes').is(':checked') ? '&notes=1' : ''; var url='<?php echo trailingslashit(site_url()) ?>?gf_page=print-entry&fid=<?php echo absint($form['id']) ?>&lid=<?php echo absint($lead['id']); ?>' + notes_qs; window.open (url,'printwindow');"
            ...
            <div class="inside">
                ...
                <div class="gform_footer">
                    ...
                    <input type="hidden" name="gform_uploaded_files"
                           id='gform_uploaded_files_<?php echo absint($form_id); ?>' value=""/>
                </div>
            </div>
        </div>
        <?php
            ...
            foreach ($notes as $note) {
                ...
                <tr valign="top">
                    ...
                    <td class="entry-detail-note<?php echo $is_last ? ' lastrow' : '' ?>">
                        ...
                        <div
                            class="detail-note-content<?php echo $class ?>"><?php echo nl2br(esc_html($note->value)) ?></div>
                    </td>
                ...
                <tr>
                    <td colspan="3" style="padding:10px;" class="lastrow">
                        ...
                        if (!empty($emails)) {
                            ...
                            &nbsp;&nbsp;
                            <span>
                                <select name="gentry_email_notes_to"
                                    ...
                                    <option
                                        value=""><?php esc_html_e('Also email this note to', 'gravityforms') ?></option>
                                    <?php foreach ($emails as $email) { ?>
                                        <option
                                            value="<?php echo esc_attr($email); ?>"><?php echo esc_html($email); ?></option>
                                    <?php } ?>
                                </select>
                                &nbsp;&nbsp;
                                ...
                                <span id='gentry_email_subject_container' style="display:none;">
                                    <label
                                        for="gentry_email_subject"><?php esc_html_e('Subject:', 'gravityforms') ?></label>
                                    <input type="text" name="gentry_email_subject" id="gentry_email_subject" value=""
                                           style="width:35%"/>
                                </span>
                            </span>
                        <?php } ?>
        ...
        <table cellspacing="0" class="widefat fixed entry-detail-view">
            ...
            <tr>
                ...
                <th style="width:140px; font-size:10px; text-align: right;">
                    ...
                    if ($allow_display_empty_fields) {
                        ?>
                        <input type="checkbox"
                               id="gentry_display_empty_fields" <?php echo $display_empty_fields ? "checked='checked'" : '' ?>
                               onclick="ToggleShowEmptyFields();"/>&nbsp;&nbsp;
                        <label
                            for="gentry_display_empty_fields"><?php esc_html_e('show empty fields', 'gravityforms') ?></label>
                        <?php
                    }
                    ?>
                </th>
            ...
            if ($has_product_fields) {
                ...
                if (!empty($products['products'])) {
                    ...
                    <tr>
                        <td colspan="2"
                            class="entry-view-field-name"><?php echo esc_html(gf_apply_filters(array('gform_order_label', $form_id), __('Order', 'gravityforms'), $form_id)); ?></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="entry-view-field-value lastrow">
                            <table class="entry-products" cellspacing="0" width="97%">
                                ...
                                <th scope="col"
                                    class="textcenter"><?php echo esc_html(gf_apply_filters(array('gform_product_qty', $form_id), __('Qty', 'gravityforms'), $form_id)); ?></th>
                    ...
                    <div id="minor-publishing" style="padding:10px;">
                        ...
                        if (!empty($payment_status)) {
                            ...
                            <div id="gf_payment_status" class="gf_payment_detail">
                                ...
                                <span id="gform_payment_status"><?php echo $payment_status; // May contain HTML
                                    ?></span>
                            </div>
                            ...
                            if (!empty($payment_date)) {
                                ...
                                <div id="gf_payment_date" class="gf_payment_detail">
                                    ...
                                    :
                                    <span
                                        id='gform_payment_date'><?php echo $payment_date; // May contain HTML ?></span>
                                </div>
                                <?php
                            }
                            ...
                            if (!empty($transaction_id)) {
                                ...
                                <div id="gf_payment_transaction_id" class="gf_payment_detail">
                                    ...
                                    :
                                    <span
                                        id='gform_payment_transaction_id'><?php echo $transaction_id; // May contain HTML ?></span>
                                </div>
                                <?php
                            }
                            ...
                            if (!rgblank($payment_amount)) {
                                ...
                                <div id="gf_payment_amount" class="gf_payment_detail">
                                    ...
                                    :
                                    <span
                                        id='gform_payment_amount'><?php echo $payment_amount; // May contain HTML ?></span>
                                </div>
                                <?php
                            }
                        }
