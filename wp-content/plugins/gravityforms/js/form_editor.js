...
function InitializeForm(form) {
    ...
    jQuery("#gform_last_page_settings").bind("click", function () {
        FieldClick(this);
    });
    jQuery("#gform_pagination").bind("click", function () {
        FieldClick(this);
    });
    jQuery(".gfield").bind("click", function () {
        FieldClick(this);
    });
...
function ToggleMultiFile(isInit) {
    ...
    if (!isInit) {
        var field = GetSelectedField();
        jQuery("#field_settings").slideUp(function () {
...
function EndUpdateForm(formId) {
    ...
    setTimeout(function () {
        jQuery('#after_update_dialog').slideUp();
    }, 5000);
}
...
function EndDuplicateField(field, fieldString, sourceFieldId) {
    ...
    newFieldElement.animate({backgroundColor: '#FFFBCC'}, 'fast', function () {
        jQuery(this).animate({backgroundColor: '#FFF'}, 'fast', function () {
            jQuery(this).css('background-color', '');
        })
    })

    newFieldElement.bind("click", function () {
        FieldClick(this);
    });
