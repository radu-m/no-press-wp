        ...
        if ($this->maybe_uninstall()) {
            ...
            if ($this->current_user_can_any($this->_capabilities_uninstall) && (!function_exists('is_multisite') || !is_multisite() || is_super_admin())) {
                ...
                <form action="" method="post">
                    ...
                    <h3>
                        <span><i
                                class="fa fa-times"></i> <?php printf(esc_html__('Uninstall %s', 'gravityforms'), $this->get_short_title()); ?></span>
                    </h3>
    ...
    public function render_uninstall()
    {
        ...
        <form action="" method="post">
            ...
            <?php if ($this->current_user_can_any($this->_capabilities_uninstall)) { ?>
                ...
                <h3><span><i
                            class="fa fa-times"></i> <?php printf(esc_html__('Uninstall %s Add-On', 'gravityforms'), $this->get_short_title()) ?></span>
                </h3>
                <div class="delete-alert alert_red">
                    ...
                    <input type="submit" name="uninstall"
                           value="<?php esc_attr_e('Uninstall  Add-On', 'gravityforms') ?>" class="button"
