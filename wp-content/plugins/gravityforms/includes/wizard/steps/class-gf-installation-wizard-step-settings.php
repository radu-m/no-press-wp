    ...
    function display()
    {
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="radio" name="enable_noconflict"
                           value="1" <?php echo $this->enable_noconflict == 1 ? "checked='checked'" : '' ?>
                           id="gform_enable_noconflict"/> <?php _e('On', 'gravityforms'); ?>&nbsp;&nbsp;
                    <input type="radio" name="enable_noconflict"
                           value="0" <?php echo $this->enable_noconflict == 1 ? '' : "checked='checked'" ?>
            ...
            <?php if (GFCommon::has_akismet()) { ?>
                <tr valign="top">
                    ...
                    <td>
                        ...
                        ?>
                        <input type="radio" name="enable_akismet" value="1" <?php checked($is_akismet_enabled, true) ?>
                               id="gforms_enable_akismet"/> <?php esc_html_e('Yes', 'gravityforms'); ?>&nbsp;&nbsp;
                        <input type="radio" name="enable_akismet"
