...
class GF_Installation_Wizard_Step_License_Key extends GF_Installation_Wizard_Step
{
    ...
    function display()
    {
        ...
        <div>
            <input type="text" class="regular-text" id="license_key" value="<?php echo esc_attr($this->license_key); ?>"
                   name="license_key" placeholder="<?php esc_attr_e('Enter Your License Key', 'gravityforms'); ?>"/>
            <?php
            ...
            <div>
                <label>
                    <input type="checkbox" id="accept_terms" value="1" <?php checked(1, $this->accept_terms); ?>
                           name="accept_terms"/>
                    <?php esc_html_e('I understand the risks', 'gravityforms'); ?> <span
