    ...
    <form class="gf-edit-shortcode-form">
        ...
        <div>
            <a href="javascript:void(0);"
               onclick="jQuery('#gf-edit-shortcode-form-advanced-attrs').toggle();"><?php _e('Advanced Options', 'gravityforms'); ?></a>
        </div>
        <br/>

        <div id="gf-edit-shortcode-form-advanced-attrs" class="gf-edit-shortcode-form-advanced-attrs"
             style="display:none;">
        </div>

        <input id="gform-update-shortcode" type="button" class="button-primary"
               value="<?php _e('Update Form', 'gravityforms'); ?>"/>
        <input id="gform-insert-shortcode" type="button" class="button-primary"
               value="<?php _e('Insert Form', 'gravityforms'); ?>"/>&nbsp;&nbsp;&nbsp;
        <a id="gform-cancel-shortcode" class="button" style="color:#bbb;"
           href="#"><?php _e('Cancel', 'gravityforms'); ?></a>
...
<script type="text/html" id="tmpl-gf-shortcode-ui-field-text">
    <div class="field-block">
        <label for="gf-shortcode-attr-{{ data.attr }}">{{ data.label }} <a href="#" onclick="return false;"
                                                                           class="gf_tooltip tooltip tooltip_{{data.action}}_{{data.attr}}"
                                                                           title="{{data.tooltip}}"><i
...
<script type="text/html" id="tmpl-gf-shortcode-ui-field-url">
    <div class="field-block">
        <label for="gf-shortcode-attr-{{ data.attr }}">{{ data.label }} <a href="#" onclick="return false;"
                                                                           ...
                                                                           title="{{data.tooltip}}"><i
                    class='fa fa-question-circle'></i></a></label>
        <input type="url" name="{{ data.attr }}" id="gf-shortcode-attr-{{ data.attr }}" value="{{ data.value }}"
               class="code"/>
    </div>
</script>
...
<script type="text/html" id="tmpl-gf-shortcode-ui-field-radio">
    <div class="field-block">
        <label for="gf-shortcode-attr-{{ data.attr }}-{{ value }}">{{ data.label }} <a href="#" onclick="return false;"
                                                                                       class="gf_tooltip tooltip tooltip_{{data.action}}_{{data.attr}}"
                                                                                       title="{{data.tooltip}}"><i
                    class='fa fa-question-circle'></i></a></label>
        <# _.each( data.options, function( label, value ) { #>
            <input id="gf-shortcode-attr-{{ data.attr }}-{{ value }}" type="radio" name="{{ data.attr }}"
                   value="{{ value }}"
...
<script type="text/html" id="tmpl-gf-shortcode-ui-field-checkbox">
    <input type="checkbox" name="{{ data.attr }}" id="gf-shortcode-attr-{{ data.attr }}" value="true"
