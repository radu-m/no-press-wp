...
class PluginOrganizer {
	...
	function check_version() {
		...
		if (get_option("PO_version_num") != "9.2.1" && !in_array($pagenow, array("plugins.php", "update-core.php", "update.php"))) {
			$this->activate();
		}
	}
	...
	function activate() {
		...
		if (get_option("PO_version_num") != "9.2.1") {
			update_option("PO_version_num", "9.2.1");
		}
	...
	function admin_menu() {
		if ( current_user_can( 'activate_plugins' ) ) {
			...
			add_action('admin_head-'.$settings_page, array($this->tpl, 'comno_press_js'));
			...
			add_action('admin_head-'.$plugin_page, array($this->tpl, 'comno_press_js'));
