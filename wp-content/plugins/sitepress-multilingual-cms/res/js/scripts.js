...
WPML_core.PostEditDuplicates = function ($) {
    ...
    var _make_duplicate_click_handler = function () {
        var langs = [];
        jQuery('#post').find('input[name="icl_dupes[]"]:checked').each(function () {
        ...
        jQuery.ajax({
            type: "POST",
            url: icl_ajx_url,
            data: "icl_ajx_action=make_duplicates&post_id=" + jQuery('#post_ID').val() + '&langs=' + langs + '&_icl_nonce=' + jQuery('#_icl_nonce_mdup').val(),
