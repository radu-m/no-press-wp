...
function icl_pop_info($message, $icon = 'info', $args = array())
{
    ...
    <div class="icl_pop_info_wrap">
        <img class="icl_pop_info_but <?php echo join(' ', $but_style) ?>" src="<?php echo $icon ?>"
             width="<?php echo $icon_size ?>" height="<?php echo $icon_size ?>" alt="info"/>

        <div class="icl_cyan_box icl_pop_info">
            <img class="icl_pop_info_but_close" align="right" src="<?php echo $close_icon; ?>" width="12" height="12"
                 alt="x"/>
            <?php echo $message; ?>
        </div>
    </div>
...
function wpml_missing_filter_input_notice()
{
    ...
    <div class="message error">
        ...
        <p><?php _e("To ensure and improve the security of your website, WPML makes use of the ", 'sitepress') ?><a
            ...
            used, however, the PECL version is no longer recommended to be used or updated. (source: ", 'sitepress') ?>
            ...
            <br><?php _e("To enable it, either you or your host will need to open your website's php.ini file and either:", 'sitepress') ?>
            <br>
        <ol>
            <li><?php _e("Remove the 'filter_var' string from the 'disable_functions' directive or...", 'sitepress') ?>
            </li>
            <li><?php _e("Add the following line:", 'sitepress') ?> <code class="inline-code">extension=filter.so</code>
            </li>
        </ol>
