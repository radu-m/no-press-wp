    ...
    if ($icl_menus_sync->is_preview) {
        ...
        <form id="icl_msync_confirm_form" method="post">
                                ...
                                foreach ($icl_menus_sync->sync_data['menu_translations'][$menu_id] as $language => $name) {
                                    ...
                                    <tr>
                                        <th scope="row" class="check-column"><input type="checkbox"
                                                                                    name="sync[menu_translation][<?php echo $menu_id ?>][<?php echo $language ?>]"
                                ...
                                foreach ($icl_menus_sync->sync_data['menu_options'][$menu_id] as $language => $option) {
                                    ...
                                    foreach ($option as $key => $value) {
                                        if (isset($menu[$key]) && $menu[$key] != $value) {
                                            ...
                                            <tr>
                                                <th scope="row" class="check-column"><input type="checkbox"
                                                                                            name="sync[menu_options][<?php echo $menu_id ?>][<?php echo $language ?>][<?php echo $key; ?>]"
                                                                                            value="<?php echo esc_attr($menu[$key]) ?>"/>
                                                </th>
                                                <td><?php echo $lang_details['display_name']; ?></td>
                                    ...
                                    foreach ($languages as $language => $name) {
                                        ...
                                        <tr>
                                            <th scope="row" class="check-column">
                                                <input type="checkbox"
                                                       name="sync[add][<?php echo $menu_id ?>][<?php echo $item_id ?>][<?php echo $language ?>]"
                                                       value="<?php echo esc_attr($name) ?>"/>
                                            </th>
                                            <td><?php echo $lang_details['display_name']; ?></td>
                                            <td><?php
                                ...
                                foreach ($icl_menus_sync->sync_data['mov'][$menu_id] as $item_id => $changes) {
                                    foreach ($changes as $language => $details) {
                                        ...
                                        <tr>
                                            <th scope="row" class="check-column">
                                                <input type="hidden"
                                                       name="sync[mov][<?php echo $menu_id ?>][<?php echo $item_id ?>][<?php echo $language ?>][<?php echo $new_menu_order ?>]"
                                                       value="<?php echo esc_attr($name) ?>"/>
                                            </th>
                                            <td><?php echo $lang_details['display_name']; ?></td>
                                            <td><?php
                                ...
                                foreach ($icl_menus_sync->sync_data['del'][$menu_id] as $language => $items) {
                                    foreach ($items as $item_id => $name) {
                                        ...
                                        <tr>
                                            <th scope="row" class="check-column">
                                                <input type="checkbox"
                                                       name="sync[del][<?php echo $menu_id ?>][<?php echo $language ?>][<?php echo $item_id ?>]"
                                                       value="<?php echo esc_attr($name) ?>"/>
                                            </th>
                                            <td><?php echo $lang_details['display_name']; ?></td>
                                            <td><?php
                                ...
                                foreach ($icl_menus_sync->sync_data['label_changed'][$menu_id] as $item_id => $languages) {
                                    foreach ($languages as $language => $name) {
                                        ...
                                        <tr>
                                            <th scope="row" class="check-column">
                                                <input type="checkbox"
                                                       name="sync[label_changed][<?php echo $menu_id ?>][<?php echo $language ?>][<?php echo $item_id ?>]"
                                                       value="<?php echo esc_attr($name) ?>"/>
                                            </th>
                                            <td><?php echo $lang_details['display_name']; ?></td>
                                            <td><?php
                                ...
                                foreach ($icl_menus_sync->sync_data['url_changed'][$menu_id] as $item_id => $languages) {
                                    foreach ($languages as $language => $url) {
                                        ...
                                        <tr>
                                            <th scope="row" class="check-column">
                                                <input type="checkbox"
                                                       name="sync[url_changed][<?php echo $menu_id ?>][<?php echo $language ?>][<?php echo $item_id ?>]"
                                ...
                                foreach ($icl_menus_sync->sync_data['label_missing'][$menu_id] as $item_id => $languages) {
                                    foreach ($languages as $language => $name) {
                                        ...
                                        <tr>
                                            <th scope="row" class="check-column">
                                                <input type="checkbox"
                                                       name="sync[label_missing][<?php echo $menu_id ?>][<?php echo $language ?>][<?php echo $item_id ?>]"
                                                       value="<?php echo esc_attr($name) ?>"/>
                                            </th>
                                            <td><?php echo $lang_details['display_name']; ?></td>
                                            <td><?php
                                ...
                                foreach ($icl_menus_sync->sync_data['url_missing'][$menu_id] as $item_id => $languages) {
                                    foreach ($languages as $language => $url) {
                                        ...
                                        <tr>
                                            <th scope="row" class="check-column">
                                                <input type="checkbox"
                                                       name="sync[url_missing][<?php echo $menu_id ?>][<?php echo $language ?>][<?php echo $item_id ?>]"
                                                       value="<?php echo esc_attr($url) ?>"/>
                                            </th>
                                            <td><?php echo $lang_details['display_name']; ?></td>
                                            <td><?php
            ...
            <p class="submit">
                ...
                ?>
                <input id="icl_msync_submit" class="button-primary" type="submit"
                       value="<?php _e('Apply changes') ?>" <?php echo $icl_menu_sync_submit_disabled; ?> />&nbsp;
        ...
        <form method="post" action="">
            ...
            <table class="widefat icl_msync">
                ...
                if (empty($icl_menus_sync->menus)) {
                    ...
                    <tr>
                        <td align="center"
                            colspan="<?php echo count($active_languages) ?>"><?php _e('No menus found', 'sitepress') ?></td>
                    </tr>
                    <?php
                } else {
                    foreach ($icl_menus_sync->menus as $menu_id => $menu) {
                            ...
                            foreach ($secondary_languages as $l) {
                                ...
                                <td>
                                    ...
                                    if (isset($menu['translations'][$l['code']]['name'])) {
                                        ...
                                        ?>
                                        <input type="text"
                                               name="sync[menu_translations][<?php echo $menu_id ?>][<?php echo $l['code'] ?>]"
                                               class="icl_msync_add" value="<?php
                                        echo esc_attr($menu['name']) . ' - ' . $l['display_name'] ?>"/>
                                        <small><?php _e('Auto-generated title. Edit to change.', 'sitepress') ?></small>
                                        <input type="hidden"
                                               name="sync[menu_options][<?php echo $menu_id ?>][<?php echo $l['code'] ?>][auto_add]"
                                               value=""/>
                                        <?php
                                    }
                                    if (isset($menu['translations'][$l['code']]['auto_add'])) {
                                        ...
                                        <input type="hidden"
                                               name="sync[menu_options][<?php echo $menu_id ?>][<?php echo $l['code'] ?>][auto_add]"
                                               value="<?php echo esc_attr($menu['translations'][$l['code']]['auto_add']); ?>"/>
                                        <?php
                                    }
                                    ?>
                                </td>
            ...
            <p class="submit">
                ...
                if ($need_sync) {
                    ...
                    <input id="icl_msync_sync" type="submit" class="button-primary"
                           value="<?php _e('Sync', 'sitepress'); ?>"<?php if (!$need_sync): ?> disabled="disabled"<?php endif; ?> />
                    <?php
                } else {
                    ?>
                    <input id="icl_msync_sync" type="submit" class="button-primary"
                           value="<?php _e('Nothing Sync', 'sitepress'); ?>"<?php if (!$need_sync): ?> disabled="disabled"<?php endif; ?> />
                    <?php
                }
                ?>
            </p>
        ...
        if (!empty($icl_menus_sync->operations)) {
            ...
            foreach ($icl_menus_sync->operations as $op => $c) {
                if ($op == 'add') {
                    ...
                    ?>
                    <span
                        class="icl_msync_item icl_msync_not"><?php _e('Item cannot be added (parent not translated)', 'sitepress'); ?></span>
                    <?php
                } elseif ($op == 'mov') {
                    ?>
                    ...
                    ?>
                    <span
                        class="icl_msync_item icl_msync_label_changed"><?php _e('Strings for menus will be updated', 'sitepress'); ?></span>
                    <?php
                } elseif ($op == 'url_changed') {
                    ?>
                    <span
                        class="icl_msync_item icl_msync_url_changed"><?php _e('URLs for menus will be updated', 'sitepress'); ?></span>
                    <?php
