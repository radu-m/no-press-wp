...
<div id="icl_update_message" class="updated message fade" style="clear:both;margin-top:5px;">
    <p>
        <img
            src="<?php echo ICL_ICONS_URL . 'icon_adv.png'; ?>"/>&nbsp;<?php echo $upgrade_lines[$short_v]['message']; ?>
    </p>
    ...
    <p>
        ...
        if ($upgrade_lines[$short_v]['dismiss']) {
            ?>
            &nbsp;|&nbsp;<a title="<?php _e('Stop showing this message', 'sitepress') ?>"
                            id="icl_dismiss_upgrade_notice" href="#"><?php _e('Dismiss', 'sitepress') ?></a>
            <?php
