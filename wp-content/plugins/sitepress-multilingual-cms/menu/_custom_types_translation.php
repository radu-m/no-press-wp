                    ...
                    <?php foreach ($custom_posts as $k => $custom_post): ?>
                        ...
                        <tr>
                                ...
                                <?php if (defined('WPML_ST_VERSION')): ?>
                                    ...
                                    <?php if ($_has_slug && isset($sitepress_settings['posts_slug_translation']['on']) && $sitepress_settings['posts_slug_translation']['on']): ?>
                                        <div class="icl_slug_translation_choice <?php echo $is_hidden; ?>">
                                            <p>
                                                <label>
                                                    <input name="translate_slugs[<?php echo $k ?>][on]" type="checkbox"
                                                           value="1" <?php checked(1, $_translate, true) ?> />
                                                    <?php printf(__('Use different slugs in different languages for %s.', 'sitepress'), $custom_post->labels->name); ?>
                                                </label>
                                            </p>

                                            <table
                                                class="js-cpt-slugs <?php if (empty($_translate)): ?>hidden<?php endif; ?>">
                                                ...
                                                foreach ($sitepress->get_active_languages() as $language) {
                                                    if ($language['code'] != $sitepress_settings['st']['strings_language']) {
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <label
                                                                    for="translate_slugs[<?php echo $k ?>][langs][<?php echo $language['code'] ?>]"><?php echo $language['display_name'] ?></label>
                                                            </td>
                                                            <td>
                                                                <input
                                                                    id="translate_slugs[<?php echo $k ?>][langs][<?php echo $language['code'] ?>]"
                                                                    name="translate_slugs[<?php echo $k ?>][langs][<?php echo $language['code'] ?>]"
                                                                    type="text"
                                                                    value="<?php echo $slug_translation_value; ?>"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <label
                                                                    for="translate_slugs[<?php echo $k ?>][langs][<?php echo $language['code'] ?>]"><?php echo $language['display_name'] ?>
                                                                    <em><?php _e("(original)", 'sitepress') ?></em></label>
                                                            </td>
                                                            <td><input disabled="disabled" class="disabled"
                                                                       id="translate_slugs[<?php echo $k ?>][langs][<?php echo $language['code'] ?>]"
                                                                       name="translate_slugs[<?php echo $k ?>][langs][<?php echo $language['code'] ?>]"
                                                                       type="text"
                            ...
                            <td align="right">
                                <p>
                                    <label>
                                        <input class="icl_sync_custom_posts" type="radio"
                                               name="icl_sync_custom_posts[<?php echo $k ?>]"
                                               value="1" <?php echo $rdisabled; ?>
                                               <?php if (@intval($sitepress_settings['custom_posts_sync_option'][$k]) == 1): ?>checked<?php endif; ?> />
                            ...
                            <td>
                                <p>
                                    <label>
                                        <input class="icl_sync_custom_posts" type="radio"
                                               name="icl_sync_custom_posts[<?php echo $k ?>]"
                                               value="0" <?php echo $rdisabled; ?>
                                               <?php if (@intval($sitepress_settings['custom_posts_sync_option'][$k]) == 0): ?>checked<?php endif; ?> />
                                        <?php _e('Do nothing', 'sitepress') ?>
                                    </label>
                                </p>
                                <?php if ($rdisabled): ?>
                                    <input type="hidden" name="icl_sync_custom_posts[<?php echo $k ?>]"
                                           value="<?php echo @intval($sitepress_settings['custom_posts_sync_option'][$k]) ?>"/>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    ...
                    <?php foreach ($custom_taxonomies as $ctax): ?>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <p>
                                    <label>
                                        <input type="radio" name="icl_sync_tax[<?php echo $ctax ?>]"
                                               value="1" <?php echo $rdisabled; ?> <?php if (@$sitepress_settings['taxonomies_sync_option'][$ctax] == 1): ?> checked<?php endif; ?> />
                                        <?php _e('Translate', 'sitepress') ?>
                                    </label>
                                </p>
                            </td>
                            <td>
                                <p>
                                    <label>
                                        <input type="radio" name="icl_sync_tax[<?php echo $ctax ?>]"
                                               value="0" <?php echo $rdisabled;
                                        if (@$sitepress_settings['taxonomies_sync_option'][$ctax] == 0): ?> checked<?php endif; ?> />
                                        <?php _e('Do nothing', 'sitepress') ?>
                                    </label>
                                </p>
                            </td>
