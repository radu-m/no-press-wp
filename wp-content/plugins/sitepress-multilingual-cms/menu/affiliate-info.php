    ...
    <form id="icl_affiliate_info_check" method="post" action="">
        ...
        <table class="widefat">
            <tr>
                ...
                <td>
                    <input type="text" name="icl_affiliate_id" readonly="readonly"
                           value="<?php echo $icl_affiliate_id ?>"/>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="icl_affiliate_key" readonly="readonly"
                           value="<?php echo $icl_affiliate_key ?>" size="38"/>
